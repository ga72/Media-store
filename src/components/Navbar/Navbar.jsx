    ...
    <div>
      <nav className={`navbar navbar-expand-lg ${style.navBg} fixed-top`}>
        <div className="container-fluid">
          ...
          <button className={`navbar-toggler ${style.button1}`} type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
